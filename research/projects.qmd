...
::: resource
- Projects are curated in the [data/projects.yml](https://github.com/fs-ise/handbook/blob/main/data/projects.yml).
- Pages are automatically generated [here](https://github.com/fs-ise/handbook/tree/main/research/projects).
