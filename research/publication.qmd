...
- [references.bib](https://github.com/fs-ise/handbook/blob/main/assets/references.bib){target=_blank} (the [publications](publications.html) page will be updated automatically).
...
- Nextcloud [publications]({{< meta nextcloud.publications >}}){target=_blank}
