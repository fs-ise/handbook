...
- [ ] Check references (in particular potential hallucinations in the last part):

```sh
labot references consolidate paper.pdf --mailto you@example.org
```
...
Open the `review.md` in an Obsidian vault (e.g., [research-hub](https://github.com/fs-ise/research-hub){target=_blank}).
