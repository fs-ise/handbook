...
- Forward decision to coauthors and clarify who leads the revision
- Update status and history in [data/projects.yml]({{< meta handbook.url >}}/blob/main/data/projects.yml){target=_blank}.

### 2. Study the review package
...
### 3. Develop a holistic understanding of the feedback
...
### 4. Formulate a revision strategy
...
### 7. Start early and establish a timeline
...
::: {.callout-note title="Expected outcome" #expected-outcome}
...
- We would like to thank Reviewer #2 for the time and effort devoted to our paper. We hope we have correctly interpreted the suggestions and recommendations.
- We believe that the revised manuscript is now more aligned with the expectations of Reviewer #2 and the potential readership of Journal XXX.
...
- As editors and reviewers suggested changes and as anticipated by the Senior Editor, the rework of the manuscript was substantial.
- Authors usually mark modifications systematically (for example, by maintaining Track Changes mode, using colored text, or highlighting text). After consulting the editor-in-chief, we submit the reworked manuscript in a clean form. On the explicit request of the reviewer, we can provide the revised version of the manuscript with Track Changes mode enabled.
...
- [Word template]({{< meta handbook.url >}}/tree/main/assets/Revision-Sheet.docx) for revisions in non-Git-based projects.
