...
- Update status and history in [data/projects.yaml](https://github.com/fs-ise/handbook/blob/main/data/projects.yml){target=_blank}.
...
- [Word template]({{< meta repo-url-main >}}/tree/main/assets/Revision-Sheet.docx) for revisions in non-Git-based projects.
