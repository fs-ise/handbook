...
::: callout-note
- Add the tags `research` and `paper` to ensure that the repository is listed correctly in the [overview](/management/github.html).
- Set the `MY_PAT_TOKEN` as a repository secret (for the Labot workflow)
:::

TODO: describe creation of GitHub repository, see [GitHub](/management/github.html) (https://github.com/organizations/fs-ise/repositories/new)
