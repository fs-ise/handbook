...
![Anatomy of a research paper](https://raw.githubusercontent.com/fs-ise/handbook/main/assets/images/anatomy_research_paper_wang.png){target=_blank}
...
Papers can be accessed through the Bamberger Katalog, a search on [ResearchGate](https://www.researchgate.net){target=_blank}, a search on Google, or by contacting the authors (see [outlets](/research/outlets.html) for more information).
...
The approach may be, for example, empirical, analytical, comparative, systematic, historical, or hermeneutic.
