...
- See [repo-example](https://github.com/fs-ise/repo-example){target=_blank}, or [deep-cenic](https://github.com/julianprester/deep-cenic){target=_blank} example.
...
TODO: summarize the use of Docker containers [see analysis directory](https://github.com/fs-ise/repo-example){target=_blank}
...
- [Data analysis with the tidyverse](https://cbdm-01.zdv.uni-mainz.de/~galanisl/danalysis/){target=_blank}
