...
- [research-hub](https://github.com/fs-ise/research-hub){target=_blank}

For knowledge management tasks, we use [Obsidian](https://obsidian.md/){target=_blank}.

- Each note (paper summary or concept) should be a separate, **atomic note** (see [1](https://zettelkasten.de/overview/){target=_blank}, [2](https://forum.obsidian.md/t/12-principles-for-using-zettelkasten/51679){target=_blank}).
...
- Existing projects: Move PDFs to git repositories with Git-LFS [Nextcloud]({{< var nextcloud.projects >}}){target=_blank}.
...
Example repository: [research-hub](https://github.com/fs-ise/research-hub){target=_blank}
...
::: resource
- [GitHub](https://github.com/orgs/fs-ise/repositories?q=topic%3Aresearch){target=_blank}
:::
