...
Python: recommendation to use [uv](https://fs-ise.github.io/handbook/docs/10-lab/17_today-i-learned/uv.html){target=_blank} to manage dependencies or include them in a script.
