...
- Physical mail (documents) related to **theses**:
  ...
  - Submissions, an issue must be created in the [theses-confidential](https://github.com/digital-work-lab/theses-confidential/issues){target=_blank}, uploading the digital version of the thesis. The paper version is [archived](/management/resources_misc.html#archive) immediately.
