...
See [FacultyManual.pdf](https://nc-2272638881871040784.nextcloud-ionos.com/index.php/apps/files/files/1728329?dir=/management/compliance&openfile=true) and [fs-code-of-conduct.pdf](https://nc-2272638881871040784.nextcloud-ionos.com/index.php/apps/files/files/1728328?dir=/management/compliance&openfile=true)
...
- Respect usage rights for teaching materials, publications, and datasets.
- Avoid unauthorized distribution or reuse of protected content.
...
<!--
      ...
      Student assistants (SHKs) and their supervisors must also proactively disclose any **family relationships that could create a conflict of interest**. In particular, if an SHK has a brother or sister who is currently studying in one of our programs, this must be reported to the professor and team assistant as early as possible so that responsibilities can be adjusted where needed (e.g., grading support, access to assessment-related information, or student-facing administrative tasks).
      ...
      Annually, at [sicherheitswesen.uni-bamberg.de](https://www.uni-bamberg.de/sicherheitswesen/){target=_blank}.
    ...
    - The task of all Bavarian universities is to promote diversity and gender equality and to counteract discrimination (cf. Art. 2 Abs. 5 and Art. 25 Abs. 2 BayHIG).
      The prohibition of discrimination based on gender is enshrined in the Basic Law (Art. 3 Abs. 3 Satz 1 GG), and the university, in its capacity as an employer, is obligated to protect against discrimination.
    - The Bavarian State Government has decided, according to the cabinet report on Tuesday, March 19, 2024, to amend the General Administrative Regulation for the authorities of the Free State of Bavaria (AGO).
      It states that the use of gender-neutral language (Gender Gap, Gender Star, colon, or mediopoint) in official correspondence is expressly prohibited.
