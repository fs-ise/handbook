...
In regular [planning and review sessions](/management/planning_review_sessions.html), we reflect on our progress, define objectives, and identify key results that align with our broader mission.
...
- Regularly check GitHub's overview of all [open issues assigned to you or with mentions](https://github.com/issues/assigned).
...
See Ben Balter’s [post](https://ben.balter.com/2015/11/18/tools-to-empower-open-collaboration/).

### Sharing contents and research results

- **Work iteratively:** Always write and share bullet points before writing paragraphs.
- **Agree on short names for research projects:** For example, use names like *BibDedupe* or *GitIntro*. Short names should be related to the topic, not the target journal (avoid referring to “the MISQ paper”).
...
- Questions related to our processes should be answered by sharing a link instead of answering the same question multiple times (e.g., [here](10.07.markdown.html#slides) are our guidelines for creating markdown slides).
