...
::: self-service
To join, please [create a GitHub account](https://github.com/signup){target=_blank} (if you do not have one yet) and start the onboarding process here: [Open Onboarding Issue](https://github.com/digital-work-lab/handbook/issues/new?template=request-onboarding.md){target=_blank}.
:::
