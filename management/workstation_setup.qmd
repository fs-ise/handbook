...
::: {.callout-note title="Thunderbird / Mail and calendar settings" collapse=true}
...
- [LanguageTools](https://github.com/languagetool-org/languagetool){target=_blank} - see [here](https://chatgpt.com/c/69d35fd3-df94-8392-b094-1f0964a56c21){target=_blank}
...
- Venvs
- Rstudio
- Whisper (see how-to) - or [speechnote](https://github.com/mkiol/dsnote){target=_blank}
...
- [Software for research](/research/systems.html)
