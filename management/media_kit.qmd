...
- [HugeIcons](https://icon-sets.iconify.design/hugeicons/){target=_blank} for Quarto (see also: [IconMonster](https://iconmonstr.com/?s=git){target=_blank}, [Font Awesome Icons](https://fontawesome.com/v4/icons/){target=_blank})
...
- [tutorial](https://www.minibooks.ch/faltanleitung.cfm){target=_blank}, [video](https://www.youtube.com/watch?v=74JNo16IDW8){target=_blank}
...
{{< qrcode https://fs-ise.github.io/open-source-project/ >}}
