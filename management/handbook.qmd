...
For anything that must be correct and consistent over time (e.g., **course offerings**, **teaching dates**, **presentations**, **paper lists**, **lab processes**), the handbook should be the **single source of truth**.
...
A good reference point is *The Turing Way*’s framing of [emergent strategy and living guidance](https://book.the-turing-way.org/foreword/emergent-strategy/).
