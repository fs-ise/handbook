...
- **Confidential data**, such as grades and student identities, must not be stored in the handbook. Instead, add a link to the confidential data store (see [example](/teaching/theses.html){target=_blank})
