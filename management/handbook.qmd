...
- Confidential data, such as grades and student identities, must not be stored in the handbook.
...
[Quarto Guide](https://quarto.org/docs/guide/){target=_blank .btn .btn-success}
</div>
