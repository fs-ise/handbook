...
::: {.callout-note title="How we implement the values and goals" collapse=true}
1. What we emphasize during [onboarding](/management/onboarding.html)
2. All of our teaching efforts follow the [*plan-do-check-adjust* cycle](/teaching/improvements.html). Our [teaching evaluations](/teaching/evaluations.html) and [improvements](/teaching/improvements.html) are available publicly.
...
We organize our work in a cadence of **first half** and **second half** of the year, starting with the *starter* and *mid-year* [planning and review session](/management/planning_review_sessions.html).
...
Our focus is particularly on commits to the `main` branch, which should always contain carefully crafted commits and no generated (unchecked) content.
...
- **Quality focus** → commits reflect considerate and valuable improvements
