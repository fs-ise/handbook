...
TODO: link to [new research repository](/research/repo_setup.html), [new teaching repository](/teaching/materials.html), etc. (showing pages explaining the use of templates instead of linking directly to new github repository)
...
def repo_sort_key(repo):
    # Sort by what users see in the table
...
def render_rows(filtered_repos,
    ...
    # Alphabetical within each category/group
