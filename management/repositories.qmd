...
[![](https://github.com/fs-ise/handbook/actions/workflows/update_repositories.yaml/badge.svg)](https://github.com/fs-ise/handbook/actions/workflows/update_repositories.yaml){target=_blank}
...
[![](https://img.shields.io/badge/Create-New%20Repository-blue)](https://github.com/organizations/fs-ise/repositories/new){target=_blank}
...
🟢 active · 🟠 inactive · 🗄️ archived (archive). Public repositories show a <img src="https://img.shields.io/badge/Public-green" alt="Public"> badge.

Labot checks (currently implemented for *active paper* repositories only): 🚨 Labot checks failing · ❓ Labot checks not found.
:::
...
def status_cell(repo, show_labot=False):
    if repo.get("archived"):
        status = '<span style="color: red;">🗄️</span>'
