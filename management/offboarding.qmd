...
See [exit interview guide](offboarding_exit_interview.html)

## Provide a reference letter

- TODO: internal link for student/research assistants
- [Template](https://github.com/fs-ise/handbook/raw/main/assets/docs/Entwurf%20Vorlage%20Arbeitszeugnis%20bei%20Ausscheiden_Neu.docx){target=_blank} for team assistants

## Remove access to accounts

- [GitHub](/management/repositories.html)
- Nextcloud
