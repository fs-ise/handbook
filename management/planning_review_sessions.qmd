...
- Were the [standard operating principles](/management/sop.html){target=_blank} implemented effectively (including the use of [agenda](/management/agendas.html){target=_blank} repository)?
