...
::: {.callout-note}
Following: The dean's office sends an email "Rückmeldung zur Verfügbarkeit für Prüfungsaufsichten - Hiwi´s mit Bachelorabschluss" with a tabl e</p> → the secretariat must forward this email to Hiwis with a Bachelor's degree with the request to return it to the dean's office and cc the secretariat.
:::
