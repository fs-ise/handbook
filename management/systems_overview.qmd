...
graph LR
    ...
    subgraph Public_Git_Sphere["GitHub"]
        ...
        subgraph Knowledge_Layer
            ResearchHub["<a href='https://github.com/fs-ise/research-hub' target='_blank'>research-hub</a>"]
            TeachingHub["<a href='https://github.com/fs-ise/teaching-hub' target='_blank'>teaching-hub</a>"]
        end

        %% Execution Layer
        subgraph Execution_Layer
            PaperProjects["<a href='repositories.html#research-repositories'>research repositories</a>"]
            LectureRepos["<a href='repositories.html#teaching-repositories'>teaching repositories</a>"]
            Templates["Templates"]
        end
