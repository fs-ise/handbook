...
graph LR
    ...
    subgraph Infrastructure_Layer["infrastructure-layer <a href='#infrastructure-layer'>🔗</a>"]
        Workstation["<a href='workstation_setup.html'>workstation-setup</a> (public)"]
    end
...
- Research Hub
- Teaching Hub
- Knowledge curations, such as [literature-reviews-information-systems](https://github.com/fs-ise/literature-reviews-in-information-systems){target=_blank} or [handbooks](https://github.com/fs-ise/handbooks){target=_blank}
