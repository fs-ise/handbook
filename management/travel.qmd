...
- Create a new folder on [Nextcloud]({{< meta nextcloud.travel >}}){target=_blank} with a new ID.
...
- Save the complete PDF in the travel folder on Nextcloud ([here]({{< meta nextcloud.travel >}}){target=_blank}).
