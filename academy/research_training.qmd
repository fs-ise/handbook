...
- [Git & GitHub Tutorial for Scientists](https://gitbookdown.dallasdatascience.com/){target=_blank}
- [Intro to reproducible reserach with R (3-day workshop)](https://r-cubed-intro.rostools.org/){target=_blank}
