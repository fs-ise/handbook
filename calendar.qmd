...
The AIS sync imports selected conference events with [`src/sync_aisnet.py`](src/sync_aisnet.py). It runs through the [AISNET sync GitHub Action](.github/workflows/sync_aisnet.yml).
