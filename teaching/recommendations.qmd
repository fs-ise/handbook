...
- Guidelines for creating a reference letter are [here]({{< var nextcloud.recommendations >}}){target=_blank}.
- The template repository is [here](https://github.com/fs-ise/quarto-template-letter){target=_blank}.