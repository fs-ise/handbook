...
- Create a [new lecture, seminar, or project](https://github.com/fs-ise/handbook/new/main/_courses){target=_blank} with this filename pattern: `2023-SuSe-IDW.md` based on the right template:
