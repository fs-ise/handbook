...
- [ ] Have the lecture announced through Frankfurt School channels where applicable (see [dissemination](/research/dissemination.html)).
...
- [ ] Have failed exams reviewed by a second professor (must be completed before entering grades in Exato)
