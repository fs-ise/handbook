...
- Template is available [here](https://github.com/fs-ise/fs-ise-presentation){target=_blank} 
- Add note on [shared-teaching-materials](https://github.com/fs-ise/shared-teaching-materials){target=_blank}
...
::: {.callout-note title="Slide shortcuts" collapse=true}
