...
- Optional: Session pages. One page per teaching session, integrating video, slides, exercise materials, code/notebooks, quizzes, and follow-up resources. (see [example](https://slds-lmu.github.io/i2ml/chapters/03_supervised_classification/03-04-classification-logistic/))
- Optional: Resource index. One cross-session page that makes all materials findable by topic, concept, method, or material type (see [example](https://harvard-iacs.github.io/2019-CS109A/pages/materials.html)).
...
- [Interesting video format](https://darribas.org/gds_course/content/bG/concepts_G.html)
