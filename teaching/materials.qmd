...
Code annotation (for slides!) (see [link](https://quarto.org/docs/authoring/code-annotation.html){target=_blank})
...
Icons: [Bootstrap](https://icons.getbootstrap.com/){target=_blank}
...
Ideally, Jupyter notebooks should be delivered through GitHub Codespaces to avoid individual setup problems [see @Malan2024].
