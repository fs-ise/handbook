...
|--------|------------------------------|--------------------------------------------------------------------|--------------------------------------------------------------------------|
| BDA    | Big Data and Analytics       | [repository](https://github.com/fs-ise/big-data-analytics)         | [repository](https://github.com/fs-ise/big-data-analytics-exams)         |
| ITSecM | IT Security Management       | [repository](https://github.com/fs-ise/it-security-management)     | [repository](https://github.com/fs-ise/it-security-management-exams)     |
| IDW    | Introduction to Digital Work | [repository](https://github.com/fs-ise/digital-work-lecture)       | [repository](https://github.com/fs-ise/digital-work-lecture-exam)        |
| OSP    | Open Source Project          | [repository](https://github.com/fs-ise/open-source-project)        | —                                                                        |
| LRSem  | Literature Review Seminar    | [repository](https://github.com/fs-ise/literature-review-seminar)  | —                                                                        |
| Theses | Theses                       | [repository](https://github.com/fs-ise/theses)                     | —                                                                        |
