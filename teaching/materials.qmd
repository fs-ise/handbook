...
See examples: [1](https://evalf22.classes.andrewheiss.com/){target=_blank} and [2] (https://evalf22.classes.andrewheiss.com/content/).
...
A useful model is JabRef’s teaching page: [Teaching with JabRef](https://devdocs.jabref.org/teaching.html){target=_blank}.
...
![](../assets/images/discussion_prompt.png){width=50%}
...
- [Interesting video format](https://darribas.org/gds_course/content/bG/concepts_G.html){target=_blank}
...
- [HBD teaching cases](https://hbsp.harvard.edu/cases/){target=_blank}
- [JISE teaching cases](https://jise.org/cases.html){target=_blank}
- [Ivey Publishing (Western University)](https://www.iveypublishing.ca/s/){target=_blank}
- [The Case Centre (casecentre.org)](https://www.thecasecentre.org/){target=_blank}
- [INSEAD case collection](https://www.thecasecentre.org/caseCollection/INSEAD){target=_blank}
- [Stanford GSB cases](https://www.gsb.stanford.edu/faculty-research/case-studies){target=_blank}
- [Journal of Open Source Education](https://jose.theoj.org/papers/published){target=_blank}
- [Proceedings of the ISCAP Conference on Information Systems and Computing Education](https://www.iscap.us/proceedings/){target=_blank}
