...
|--------|------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| BDA    | Analytics and Big Data       | [repository](https://github.com/fs-ise/big-data-analytics){target=_blank}         | [repository](https://github.com/fs-ise/big-data-analytics-exams){target=_blank}         |
