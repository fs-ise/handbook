...
- Materials: [repository](https://github.com/digital-work-lab/digital-work-lecture){target=_blank}
- Exams: [repository](https://github.com/digital-work-lab/digital-work-lecture-exam){target=_blank}

### Open Source Project (OSP)

- Materials: [repository](https://github.com/digital-work-lab/open-source-project){target=_blank}

### Literature Review Seminar (LRSem)

- Materials: [repository](https://github.com/digital-work-lab/literature-review-seminar){target=_blank}
