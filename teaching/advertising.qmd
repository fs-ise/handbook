...
- Update poster and have it printed ([link](https://github.com/fs-ise/handbook/tree/main/assets/docs/teaching-poster){target=_blank})
...
::: {.callout-note title="Projekt OSP"}
...
::: {.callout-note title="Lecture IDW"}
...
::: {.callout-note title="Seminar LRSem"}
