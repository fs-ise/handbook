...
Use teaching-repository-template to [create a new repository from the template](https://github.com/new?template_name=teaching-repository-template&template_owner=fs-ise).
