...
The thesis advisor (professor) grades the thesis based on the template (created by labot) and the predefined [criteria](https://fs-ise.github.io/theses/docs/evaluation.html){target=_blank}.
