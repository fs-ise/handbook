...
::: callout-tip
This page contains **administration details**. For students, information is available on a [separate page](https://fs-ise.github.io/theses/){target=_blank}.
:::

::: confidential
Information on individual theses is recorded internally: ([nextcloud/teaching/theses]({{< var nextcloud.theses >}})).
:::
...
<!--
    ...
    - 1 original with the signature of the professor and the student **for archiving at the chair** (added to the [archive]({{< var nextcloud.grades >}}){target=_blank}).
    ...
    - The script creates a folder in the [theses overview](https://github.com/fs-ise/theses-confidential/){target=_blank}.
    - Moves the documents to [Nextcloud]({{< var nextcloud.theses >}}){target=_blank}.
    ...
    ![Registration](https://raw.githubusercontent.com/fs-ise/handbook/main/assets/images/thesis-registration.png){target=_blank}

    - Sends an e-mail containing the Word document to the examination office, which enters the topic and the day of the topic issue into FlexNow:
...
- Students send a request for thesis supervision via e-mail
- Once confirmed by supervisors, students send the request via SuSy
- Supervisors confirm supervision via SuSy
- Suggest a first meeting (via bookings):


```Markdown
Dear STUDENTNAME,

I have just confirmed the supervision in SuSy. Should we schedule a meeting for next week to discuss next steps, criteria, and open questions?

You can find my bookings page and the thesis page with additional information here:

https://bookings.cloud.microsoft/bookwithme/?anonymous=&ismsaljsauthenabled=

https://fs-ise.github.io/theses/
...
Notes on thesis advising and process are stored internally on [Nextcloud]({{< var nextcloud.theses >}}){target=_blank}.
...
- The grading template is available [here](https://github.com/fs-ise/handbook/raw/main/assets/templates/evaluation_thesis_presentation/thesis_presentation.docx){target=_blank}
...
The thesis advisor (professor) grades the thesis based on the template (created by labot) and the predefined [criteria](https://fs-ise.github.io/theses/docs/feedback.html){target=_blank}.

- A thesis is checked for plagiarism.
  In case plagiarism is detected, the [Plagiarism Process](/teaching/plagiarism.html) is started.
...
- The deadline is given by the examination office. Our goal is to grade theses within two weeks.
- Spell-check the review.
- The review (PDF) is archived on [Nextcloud]({{< var nextcloud.grades >}}){target=_blank}.
...
>
> Ich habe das Gutachten zu Ihrer Bachelorarbeit erstellt. Vorab möchte ich Ihnen schon inoffiziell mitteilen, dass Ihre Arbeit mit der Note XXXXXX bewertet wird.
>
> Herzlichen Glückwunsch zu dieser hervorragenden Leistung!
>
> Abschließend möchte ich Sie zu einem Feedbackgespräch einladen, um die Bewertung und den Prozess zu besprechen. Ich würde mich freuen, wenn Sie diese Möglichkeit wahrnehmen. Einen Termin können Sie über Bookings auswählen:
>
> https://bookings.cloud.microsoft/bookwithme/?anonymous=&ismsaljsauthenabled=
>
> Mit besten Grüßen
...
> Sehr geehrte/r Frau/Herr XXXXX,
>
> Ich habe das Gutachten zu Ihrer Masterarbeit erstellt. Vorab möchte ich Ihnen schon inoffiziell mitteilen, dass die schriftliche Arbeit mit der Note XXXXXX bewertet wird. Die Präsentation wird mit XXXX bewertet.
>
> Herzlichen Glückwunsch zu dieser hervorragenden Leistung!
>
> Abschließend möchte ich Sie zu einem Feedbackgespräch einladen, um die Bewertung und den Prozess zu besprechen. Ich würde mich freuen, wenn Sie diese Möglichkeit wahrnehmen. Einen Termin können Sie über Bookings auswählen:
...
We provide [feedback](https://fs-ise.github.io/theses/docs/feedback.html){target=_blank} on the thesis and explain the grading.
