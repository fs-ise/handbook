...
::: callout-important
Do not reuse old exams
Students have a large Dropbox folder with previous exams.
:::
...
- Exam dates: pruefungsorganisation@fs.de
- Klausurtermine in TimeEdit einsehen: als Mitarbeiter in TimeEdit einloggen. Danach entweder **Alle Raumbuchungen** öffnen (Prüfungen zwischen dem 22.05. und 30.05. über den jeweiligen Tag einsehbar) oder den **Prüfungsplan** nutzen (Datum in der Kopfzeile einstellen und die passende Klausur über die Suche finden).
- Provide exam 2 weeks before examination dates, as a PDF document
- Add space for the solutions

## Examination day

## Grading

- Exato: Link shared by Prüfungsorganisation.
- Korrektur: 3 wochen (über Weihnachten) -> als 15 Arbeitstage interpretiert
- Either in digital or paper form
- Check for grade distribution: https://nc-2272638881871040784.nextcloud-ionos.com/index.php/apps/files/files/1728329?dir=/management/compliance&openfile=true

## Entering grades

- Group work graded in Canvas: Send and E-Mail to <pruefungsorganisation@fs.de>, asking them to run the Gradetransfer
...
- Noten eintragen
- Noten freigeben
- Noten als PDF in Nextcloud ablegen (ggf. Excel-Datei löschen)
