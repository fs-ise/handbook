...
- For exams, reviews and appeals are handled throug ExatoExam (we receive a notification when the process has started).
- For theses, reviews and appeals are handled through [SuSy](https://susy.frankfurt-school.de/){target=_blank}.
