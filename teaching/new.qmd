...
- Announcement and scheduling is documented [here](/teaching/course_organization.html)
...
- [ ] Professor: Analyse the evaluations, store the files, and document the improvements (see [evaluations](/teaching/evaluations.html)).
- [ ] Professor: [Report](/management/teaching_reports.html) teaching efforts at the end of the semester.
