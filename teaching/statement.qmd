...
1. **Understand, design, and responsibly shape digital work in socio-technical systems**, 
  equipping students with transferable methods and competencies for interdisciplinary collaboration in evolving digital environments.
1. **Develop technical competencies** for digital work, including analytical coding, collaborative software development, professional environment management, reproducibility via virtualized containers, and the integration of distributed systems and knowledge workflows.
1. **Foster critical thinking, ethical judgment, and reflective engagement**, 
...
Writing teaching tips and cases, such as @WagnerThurner2025 and @PareWagnerPrester2024, captures tangible results of our work and serves as a way to exchange new perspectives with the pedagogical discourse. 
...
This has led to a range of student papers, including @SchusterWagnerSchryen2018, @WagnerEmplSchryen2020, and @WagnerThurner2025; awards such as *Christa Lindner Prizes*, or the *Best Theory Paper Award at the International Conference on Information Systems*; as well as the co-authoring of research software, such as @EckhardtEtAlSearchQuery and @WagnerPresterCoLRev.
